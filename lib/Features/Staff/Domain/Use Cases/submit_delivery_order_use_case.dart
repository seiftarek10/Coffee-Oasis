...
class SubmitDeliveryOrderUseCase extends UseCase<void, UserOrderEntity> {
  final StaffRepo _staffRepo;

  SubmitDeliveryOrderUseCase(this._staffRepo);
  @override
  Future<Either<Failure, void>> execute({UserOrderEntity? param}) async {
    return await _staffRepo.submitDeliveryOrder(userOrder: param!);
  }
}
