...
import 'package:coffee_oasis/Features/User/Presentation/Views/Widgets/Coffee%20Details%20%20View%20Widgtss/Bloc%20Widgets/manage_favorite_item_bloc_listner.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Spacer(),
        ManageFavoriteIconBlocListner(coffee: coffee)
      ],
    );
  }
}
