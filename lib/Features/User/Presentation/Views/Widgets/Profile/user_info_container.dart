...
import 'package:coffee_oasis/Features/User/Presentation/Views/Widgets/Profile/Bloc%20Widgets/sign_out_bloc_listner.dart';
      ...
      AppWhiteContainer(
        ...
        GestureDetector(
            ...
            child: const ProfileInfoItem(
                title: 'Favorite', info: '', editItem: false)),
        Space.k20,
        SignOutBlocListner(
          child: GestureDetector(
              onTap: () async {
                await BlocProvider.of<SignOutCubit>(context).singOut();
              },
              child: const ProfileInfoItem(
                  title: 'Log Out', info: '', editItem: false)),
        )
      ]))
    ]));
  }
